...
public class NetworkTankEnemyIdleState : NetworkTankEnemyState
{
    //private int _currentPatrolingTarget = 0;
    public NetworkTankEnemyIdleState(NetworkTankEnemyController enemy) : base(enemy) { }
    ...
    public override void OnStateUpdate()
    {
        ...
        {
            _enemy.ChangeState(new NetworkTankEnemyAttackState(_enemy));
        }
    }
}
